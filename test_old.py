...
if os.name == 'nt':
    ...
    child = PopenSpawn(maven_path + ' -e openmrs-sdk:setup', encoding="utf-8")
elif os.name == 'posix':
...
child.sendline('')
child.expect('Failed to setup server: Failed to connect to the specified database', timeout=5)
exit(0)
